...
![model](E:\Github\Medium-range Trajectory Prediction Network Compliant to Physical Constraint for Oceanic Eddy\img\model.png)



And the structure of the variant LSTM is illustrated as:

![TraceLSTM](E:\Github\Medium-range Trajectory Prediction Network Compliant to Physical Constraint for Oceanic Eddy\img\TraceLSTM.png)
